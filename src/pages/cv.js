...
import Card from "../components/cardCV/cardCV"
import CardCourse from "../components/cardCV/cardCVCourse"
import {
  AdobeXD,
  Craft,
  CreativeCloud,
...
const IndexPage = () => (
  <ParallaxProvider>
    <Layout animation="false" seo="Curriculum Vitae" crumb="Curriculum Vitae">
      <main>
        <BackgroundTitle anchor="cv-start" title="Persönliches">
          <p>
            ...
            Fokus auf das Endziel zu legen: dem Benutzer ein schönes,
            funktionales und verständliches Produkt zu liefern. Dank meiner
            langjährigen Erfahrung im Bereich Typografie&#x202F;&&#x202F;Design,
            kann ich bewährte Grundwerte in die digitale Welt adaptieren und so
